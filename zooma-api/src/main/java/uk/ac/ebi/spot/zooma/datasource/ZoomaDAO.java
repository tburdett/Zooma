...
import uk.ac.ebi.spot.zooma.exception.NoSuchResourceException;
import uk.ac.ebi.spot.zooma.exception.ResourceAlreadyExistsException;
...
public interface ZoomaDAO<I> {
     ...
     * exists in zooma, this operation will fail with an {@link uk.ac.ebi.spot.zooma.exception.ResourceAlreadyExistsException}.
     *
     * @param identifiable the identifiable to add to zooma
     * @throws uk.ac.ebi.spot.zooma.exception.ResourceAlreadyExistsException
     ...
     * exists, this operation will fail with an {@link uk.ac.ebi.spot.zooma.exception.NoSuchResourceException}.
     *
     * @param object the identifiable in zooma to update (identity is assumed by matching URI)
     * @throws uk.ac.ebi.spot.zooma.exception.NoSuchResourceException
