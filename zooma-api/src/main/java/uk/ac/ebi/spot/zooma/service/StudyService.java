...
/**
 * A service that allows direct retrieval of a {@link uk.ac.ebi.spot.model.Study} or sets of Studies from ZOOMA.
 * <p/>
 * This is a high level interface that provides some degree of abstraction over the underlying datasource
 * implementation.  Most implementations will delegate requests to an {@link uk.ac.ebi.spot.zooma.datasource .StudyDAO}
