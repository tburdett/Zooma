 ...
 * @author Tony Burdett
 * @date 01/08/13
 * @see uk.ac.ebi.spot.zooma.service.AnnotationSearchService
 * @see uk.ac.ebi.spot.zooma.service.AnnotationSummarySearchService
 * @see uk.ac.ebi.spot.zooma.service.PropertySearchService
 */
